...
const questions = [
  ...
  ["Como funcionam os dois dias?", "No dia 20, palestras, talks e encontros com empresas. No dia 21, o hackathon: desenvolvimento, mentoria, pitches e premiação."],
      ...
      <main id="conteudo">
        ...
        <div className="aperture-hero">
          ...
          <div className="hero-copy">
            <p className="event-date">20–21 de fevereiro de 2027 <span aria-hidden="true">·</span> <span>João Pessoa, PB</span></p>
        ...
        <div className="shell event-facts" aria-label="Sobre o encontro">
          <span><i />Por estudantes, para estudantes.</span><span>Presencial · João Pessoa, PB</span><span>20 + 21 fevereiro / 2027</span><a href="#evento">Explore o encontro <span aria-hidden="true">↓</span></a>
        </div>
        <section id="evento" className="shell story-section">
          ...
          <div className="story-art"><div className="art-caption"><span>HACK YOUR PATH</span><span>001 — 2027</span></div><Image src="/images/brand/graphics/sphere.svg" alt="" width={360} height={360} /><div className="art-bottom"><span>Mesmas pessoas.<br /><strong>Novos caminhos.</strong></span><span aria-hidden="true">↗</span></div></div>
        </section>
        ...
        <section className="shell closing-section"><div className="closing-art"><Image src="/images/brand/graphics/arrow.svg" alt="" width={260} height={260} /></div><div className="closing-copy"><p className="eyebrow">Seu próximo passo</p><h2>O caminho não está pronto.<br /><strong>Ainda bem.</strong></h2><p>Entre na lista. A gente te avisa quando for hora de começar.</p><NotifySignup variant="footer" className="signup-button signup-dark" localPreview={localPreview} /><span className="closing-meta">20–21 de fevereiro de 2027 · João Pessoa, PB</span></div></section>
        <section className="shell partner-section" aria-labelledby="partners-title"><div><p className="eyebrow">Patrocinadores</p><h2 id="partners-title">Quem torna isso possível.</h2></div><ul>{sponsors.map((sponsor) => <li key={sponsor.name}><a href={sponsor.url} target="_blank" rel="noopener noreferrer" aria-label={`${sponsor.name} (abre em nova aba)`}><Image src={sponsor.logo} alt={sponsor.name} width={sponsor.width} height={sponsor.height} /></a></li>)}</ul><p>Quer levar sua marca para o Hack The Path? <a href="https://instagram.com/trilhaufpb" target="_blank" rel="noopener noreferrer">Fale com a gente ↗</a></p></section>
      </main>
      <footer className="shell site-footer"><Image src="/images/logo/svg/hack-the-path-02.svg" alt="Hack The Path" width={158} height={33} /><p>20–21 fev 2027 · João Pessoa, PB</p><div><a href="https://www.instagram.com/hackthepath/" target="_blank" rel="noopener noreferrer">Instagram ↗</a><Link href="/privacidade">Privacidade</Link></div></footer>
    </div>
  );
}
