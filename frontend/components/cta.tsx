  ...
  return (
    <section className="flex flex-col items-center rounded-t-[24px] bg-black px-5 pt-16 text-white sm:rounded-t-[30px] sm:px-14 sm:pt-[clamp(96px,11vw,150px)]">
      <div className="flex w-full max-w-[720px] flex-col items-center gap-6 pb-16 text-center sm:gap-8 sm:pb-[clamp(96px,11vw,150px)]">
        <p
          data-reveal
          className="m-0 text-[13px] font-bold uppercase tracking-[0.2em] text-htp-blue"
        >
          Inscrições em breve
        </p>
        <h2
          data-reveal={80}
          className="m-0 text-[clamp(40px,5.6vw,80px)] font-black leading-[0.98] tracking-[-0.03em]"
        >
          Aceite o desafio.
        </h2>
        <p data-reveal={160} className="m-0 max-w-[520px] text-[clamp(16px,1.4vw,19px)] leading-relaxed text-[#aaa]">
